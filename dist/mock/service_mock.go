...
func (m *MockIStaffService) ListStaff(ctx context.Context, params model.ListStaffParams, filterParams types.FilterStaffParams) ([]model.ListStaffRow, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListStaff", ctx, params, filterParams)
...
func (mr *MockIStaffServiceMockRecorder) ListStaff(ctx, params, filterParams interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListStaff", reflect.TypeOf((*MockIStaffService)(nil).ListStaff), ctx, params, filterParams)
}
...
func (mr *MockIStaffServiceMockRecorder) UpdateStaffServingStatus(ctx, staffInfo, status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateStaffServingStatus", reflect.TypeOf((*MockIStaffService)(nil).UpdateStaffServingStatus), ctx, staffInfo, status)
}
...
func (m *MockIRoomService) CreateRoom(ctx context.Context, deviceId, name string) (model.Room, model.Member, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateRoom", ctx, deviceId, name)
	ret0, _ := ret[0].(model.Room)
	ret1, _ := ret[1].(model.Member)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}

// CreateRoom indicates an expected call of CreateRoom.
func (mr *MockIRoomServiceMockRecorder) CreateRoom(ctx, deviceId, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRoom", reflect.TypeOf((*MockIRoomService)(nil).CreateRoom), ctx, deviceId, name)
}

// GetStaffRooms mocks base method.
func (m *MockIRoomService) GetStaffRooms(ctx context.Context, staffId int64) ([]int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStaffRooms", ctx, staffId)
	ret0, _ := ret[0].([]int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetStaffRooms indicates an expected call of GetStaffRooms.
func (mr *MockIRoomServiceMockRecorder) GetStaffRooms(ctx, staffId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStaffRooms", reflect.TypeOf((*MockIRoomService)(nil).GetStaffRooms), ctx, staffId)
}
...
func (mr *MockIRoomServiceMockRecorder) ListRoom(ctx, params, filterParams interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListRoom", reflect.TypeOf((*MockIRoomService)(nil).ListRoom), ctx, params, filterParams)
}

// ListStaffRoom mocks base method.
func (m *MockIRoomService) ListStaffRoom(ctx context.Context, params model.ListStaffRoomParams, filterParams types.FilterStaffRoomParams) ([]model.ListStaffRoomRow, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListStaffRoom", ctx, params, filterParams)
...
func (mr *MockIRoomServiceMockRecorder) ListStaffRoom(ctx, params, filterParams interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListStaffRoom", reflect.TypeOf((*MockIRoomService)(nil).ListStaffRoom), ctx, params, filterParams)
}
...
func (mr *MockITagServiceMockRecorder) ListTag(ctx, params, filterParams interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTag", reflect.TypeOf((*MockITagService)(nil).ListTag), ctx, params, filterParams)
}
...
// MockIFastMessageService is a mock of IFastMessageService interface.
type MockIFastMessageService struct {
	ctrl     *gomock.Controller
	recorder *MockIFastMessageServiceMockRecorder
}

// MockIFastMessageServiceMockRecorder is the mock recorder for MockIFastMessageService.
type MockIFastMessageServiceMockRecorder struct {
	mock *MockIFastMessageService
}

// NewMockIFastMessageService creates a new mock instance.
func NewMockIFastMessageService(ctrl *gomock.Controller) *MockIFastMessageService {
	mock := &MockIFastMessageService{ctrl: ctrl}
	mock.recorder = &MockIFastMessageServiceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockIFastMessageService) EXPECT() *MockIFastMessageServiceMockRecorder {
	return m.recorder
}

// CreateCategory mocks base method.
func (m *MockIFastMessageService) CreateCategory(ctx context.Context, params model.CreateFastMessageCategoryParams) error {
	m.ctrl.T.Helper()
...
func (mr *MockIFastMessageServiceMockRecorder) CreateCategory(ctx, params interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCategory", reflect.TypeOf((*MockIFastMessageService)(nil).CreateCategory), ctx, params)
}

// CreateFastMessage mocks base method.
func (m *MockIFastMessageService) CreateFastMessage(ctx context.Context, params model.CreateFastMessageParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateFastMessage", ctx, params)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateFastMessage indicates an expected call of CreateFastMessage.
func (mr *MockIFastMessageServiceMockRecorder) CreateFastMessage(ctx, params interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateFastMessage", reflect.TypeOf((*MockIFastMessageService)(nil).CreateFastMessage), ctx, params)
}

// DeleteFastMessage mocks base method.
func (m *MockIFastMessageService) DeleteFastMessage(ctx context.Context, id int64) error {
	m.ctrl.T.Helper()
...
func (mr *MockIFastMessageServiceMockRecorder) DeleteFastMessage(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteFastMessage", reflect.TypeOf((*MockIFastMessageService)(nil).DeleteFastMessage), ctx, id)
}

// GetFastMessage mocks base method.
func (m *MockIFastMessageService) GetFastMessage(ctx context.Context, id int64) (model.FastMessage, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIFastMessageServiceMockRecorder) GetFastMessage(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFastMessage", reflect.TypeOf((*MockIFastMessageService)(nil).GetFastMessage), ctx, id)
}

// ListCategory mocks base method.
func (m *MockIFastMessageService) ListCategory(ctx context.Context) ([]model.Constant, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIFastMessageServiceMockRecorder) ListCategory(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListCategory", reflect.TypeOf((*MockIFastMessageService)(nil).ListCategory), ctx)
}

// ListFastMessage mocks base method.
func (m *MockIFastMessageService) ListFastMessage(ctx context.Context, params model.ListFastMessageParams, filterParams types.FilterFastMessageParams) ([]model.ListFastMessageRow, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListFastMessage", ctx, params, filterParams)
...
func (mr *MockIFastMessageServiceMockRecorder) ListFastMessage(ctx, params, filterParams interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListFastMessage", reflect.TypeOf((*MockIFastMessageService)(nil).ListFastMessage), ctx, params, filterParams)
}

// ListFastMessageGroup mocks base method.
func (m *MockIFastMessageService) ListFastMessageGroup(ctx context.Context) ([]pkg.FastMessageGroupItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListFastMessageGroup", ctx)
	ret0, _ := ret[0].([]pkg.FastMessageGroupItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListFastMessageGroup indicates an expected call of ListFastMessageGroup.
func (mr *MockIFastMessageServiceMockRecorder) ListFastMessageGroup(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListFastMessageGroup", reflect.TypeOf((*MockIFastMessageService)(nil).ListFastMessageGroup), ctx)
}

// UpdateFastMessage mocks base method.
func (m *MockIFastMessageService) UpdateFastMessage(ctx context.Context, params model.UpdateFastMessageParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateFastMessage", ctx, params)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateFastMessage indicates an expected call of UpdateFastMessage.
func (mr *MockIFastMessageServiceMockRecorder) UpdateFastMessage(ctx, params interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateFastMessage", reflect.TypeOf((*MockIFastMessageService)(nil).UpdateFastMessage), ctx, params)
}
...
// DailyGuestReport indicates an expected call of DailyGuestReport.
func (mr *MockIReportServiceMockRecorder) DailyGuestReport(ctx, startDate, endDate interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DailyGuestReport", reflect.TypeOf((*MockIReportService)(nil).DailyGuestReport), ctx, startDate, endDate)
}
...
// DailyTagReport indicates an expected call of DailyTagReport.
func (mr *MockIReportServiceMockRecorder) DailyTagReport(ctx, startDate, endDate interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DailyTagReport", reflect.TypeOf((*MockIReportService)(nil).DailyTagReport), ctx, startDate, endDate)
}
...
func (m *MockIMemberService) GetOrCreateMember(ctx context.Context, name, deviceId string) (model.Member, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOrCreateMember", ctx, name, deviceId)
...
func (mr *MockIMemberServiceMockRecorder) GetOrCreateMember(ctx, name, deviceId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIRoleService) ListRole(ctx context.Context, params model.ListRoleParams, filterParams types.FilterRoleParams) ([]model.Role, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListRole", ctx, params, filterParams)
	ret0, _ := ret[0].([]model.Role)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockIRoleServiceMockRecorder) ListRole(ctx, params, filterParams interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListRole", reflect.TypeOf((*MockIRoleService)(nil).ListRole), ctx, params, filterParams)
}
...
func (mr *MockINoticeServiceMockRecorder) ListNotice(ctx, params, filterParams interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListNotice", reflect.TypeOf((*MockINoticeService)(nil).ListNotice), ctx, params, filterParams)
}
