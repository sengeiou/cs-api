...
func (s *service) DailyTagReport(ctx context.Context, startDate, endDate time.Time) ([]pkg.DailyTagReportColumn, map[string]map[string]int32, error) {
...
func (s *service) DailyGuestReport(ctx context.Context, startDate, endDate time.Time) (map[string]int32, error) {
